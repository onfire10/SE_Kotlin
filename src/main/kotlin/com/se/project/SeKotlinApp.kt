...
import com.se.project.config.ApplicationProperties
...
class SeKotlinApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes SE_Kotlin.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<SeKotlinApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(SeKotlinApp::class.java)
