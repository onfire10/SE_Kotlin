...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.se.project.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.se.project.repository.UserRepository.USERS_BY_EMAIL_CACHE)
